...
public final class IoFields {
    ...
    public static final String EXPORT_SUCCESS_LOG = "Data has been successfully exported";
    ...
    public static final String LOADING_ERROR = "An error occurred when setting up the stage";
}
